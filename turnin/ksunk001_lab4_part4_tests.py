...
tests = [ {'description': 'Initial State => PortB = 0x00',
    'steps': [ {'inputs': [('PINA',0x00)], 'iterations': 2 } ],
    'expected': [('PORTB',0x00)],
    },
    {'description': 'Lock => PortB = 0x00',
    'steps': [ {'inputs': [('PINA',0x80)], 'iterations': 5 }, 
	],
    'expected': [('PORTB',0x00),('PORTC',0x05)],
    },
    {'description': 'unlock => PortB = 0x01',
    ...
    'expected': [('PORTC',0x01),('PORTB',0x01)],
    },
    {'description': 'unlock then lock => PortB = 0x00',
    'steps': [ {'inputs': [('PINA',0x04)], 'iterations': 5 },
                {'inputs': [('PINA',0x00)], 'iterations': 5 },
                {'inputs': [('PINA',0x02)], 'iterations': 5 },
                #{'inputs': [('PINA',0x02)], 'iterations': 5 },
